...
export class AuthController {
  ...
  private isValidUser(
    user: unknown,
  ): user is Document<unknown, unknown, IUser> & IUser {
    return (
      user !== null &&
      typeof user === "object" &&
      "_id" in user &&
    ...
    try {
      ...
      next(
        error instanceof AuthenticationError
          ? error
          : new AuthenticationError("Kayıt işlemi başarısız"),
      );
    }
  }
  ...
  public async login(
    ...
    try {
      ...
      next(
        error instanceof AuthenticationError
          ? error
          : new AuthenticationError("Giriş işlemi başarısız"),
      );
    }
  }
  ...
  public async refreshToken(
    ...
    try {
      ...
      next(
        error instanceof AuthenticationError
          ? error
          : new AuthenticationError("Token yenileme başarısız"),
      );
    }
  }
  ...
  public async logout(
    ...
    try {
      ...
      next(
        error instanceof AuthenticationError
          ? error
          : new AuthenticationError("Çıkış işlemi başarısız"),
      );
    }
  }
}
